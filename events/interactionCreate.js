    ...
    switch (req) {
        case 'createTicket': {
            ...
            selectMenu.addOptions([
                ...
                {
                    emoji: '💎',
                    label: 'BOT SATIN ALIN',
                    description: 'BOT SATIN ALIN',
                    value: 'newTicket_BOT'
                },
                {
                    emoji: '❓',
                    label: 'SORULAR SORUN',
                    description: 'SORU SORUN',
                    value: 'newTicket_soru'
                },
                {
                    emoji: '🙋',
                    label: 'Destek Müşteri Destek',
                    description: 'Ürününüz ile ilgili sıkıntı yaşadığınızda ticket açın',
                    value: 'newTicket_üründestek'
                },
            ]);
        ...
        case 'newTicket': {
            ...
            const category = int.guild.channels.cache.get(categoryId);

            if (!category || category.type !== 'GUILD_CATEGORY') {
                return console.error('Belirtilen kategori bulunamadı!');
            }

            const channel = await int.guild.channels.create(`ticket-${ticketCounter}`, {
                type: 'GUILD_TEXT',
